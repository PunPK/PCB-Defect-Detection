        ...
        <div className="col-span-8 flex flex-col gap-1.5 min-h-0">
            ...
            <div className="flex items-center justify-between mb-1 shrink-0">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <button
                  ...
                  className={`touch-btn px-2.5 py-1 rounded-lg border text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer ${
                    isDark
          ...
          >
            ...
            <button
              ...
              className={`touch-btn h-full px-2.5 rounded-lg border text-xs font-semibold flex items-center gap-1 transition-all cursor-pointer ${
                isDark
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 space-y-0.5 text-[10px] sm:text-[11px]">
                ...
                <div className="flex items-center justify-between pt-0.5">
                  <div className={`flex items-center gap-1 ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                    <Archive className={`w-3 h-3 shrink-0 ${isDark ? "text-cyan-400" : "text-blue-600"}`} />
            ...
            <div className="flex-1 min-h-0 flex flex-col justify-around py-0.5 text-xs">
              {[
                ...
                return (
                  ...
                  >
                    <div className={`flex items-center gap-1.5 ${isDark ? "text-slate-400" : "text-slate-600 font-medium"}`}>
                      <RowIcon className={`w-3 h-3 shrink-0 ${isDark ? "text-cyan-400" : "text-blue-600"}`} />
