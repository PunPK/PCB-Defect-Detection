                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-start mb-12">
                        <div className="max-w-2xl">
                            <span className="text-blue-400 font-mono text-xl tracking-widest">STEP 03</span>
                            <h2 className="mb-3 text-4xl font-bold text-white">
                                View and export results PCB
                            </h2>
                            <p className="text-gray-400 font-light text-lg max-w-3xl leading-relaxed">
                                สรุปผลการตรวจสอบทั้งหมด จากจุดที่ผิดพลาดของความต่างกันของ PCB ทั้ง 2 แผ่น ที่ตรวจสอบได้ด้วยเทคโนโลยี AI
                            </p>
                        </div>
