...
const Button = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md font-medium transition-all duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  const variants = {
    ...
    outline:
      "border border-gray-700 hover:border-cyan-500/70 bg-transparent hover:bg-gray-800/50 text-gray-300",
    danger:
                      ...
                      analysisPCB ? (
                        ...
                        <div className="space-y-8 mt-3">
                          ...
                          <div className="text-center relative">
                            ...
                            <span className="relative bg-[#050816] px-4 text-gray-400">
                              หรือ
                            </span>
                          </div>
