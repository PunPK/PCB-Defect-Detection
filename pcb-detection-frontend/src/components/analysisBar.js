        ...
        <>
            ...
            <div className="fixed left-0 top-0 h-full w-64 lg:w-72 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4 lg:p-6 border-r border-gray-200 dark:border-gray-700 shadow-sm z-50 overflow-y-auto">
                ...
                <div className="relative">
                    ...
                    {/* Steps container - added max-h-[calc(100vh-150px)] and overflow-y-auto */}
                            ...
                            >
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        <h3 className={`text-base lg:text-lg font-medium ${index > activeStep ? "text-gray-400 dark:text-gray-500" : ""}`}>
                                            {step.title}
                                        </h3>
                                        {index <= activeStep && (
                                            <ChevronRight className="w-4 h-4 text-green-500 dark:text-green-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                                        )}
                                    </div>
                                    <p className={`mt-1 text-xs lg:text-sm ${index > activeStep ? "text-gray-400 dark:text-gray-500" : "opacity-80"}`}>
                                        {step.description}
                                    </p>
                                    {index > activeStep && (
