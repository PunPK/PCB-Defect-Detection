...
def detect_copper_wires(image_path):
    # โหลดภาพและแปลงสี
...
# เรียกใช้ฟังก์ชัน
result_image = detect_copper_wires("test_functions/test.png")

# แสดงผลใน OpenCV window
cv2.imshow('Detected Copper Wires and Holes', cv2.cvtColor(result_image, cv2.COLOR_RGB2BGR))
cv2.waitKey(0)
